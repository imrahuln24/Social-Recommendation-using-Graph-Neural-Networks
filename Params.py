...
def parse_args():
	...
	parser.add_argument('--adaptive', action='store_true', help='Enable adaptive time partitioning')
	parser.add_argument('--overlap', type=float, default=0.25, help='Temporal overlap between graphs')
